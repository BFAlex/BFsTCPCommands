//
//  AMBACameraCommandsViewController.h
//  RemoteCam
//
...
@interface AMBACameraCommandsViewController : UIViewController <UITextViewDelegate,UIAlertViewDelegate>//<UIPickerViewDataSource, UIPickerViewDelegate>
