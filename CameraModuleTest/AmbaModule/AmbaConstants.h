...
#ifndef AmbaConstants_h
#define AmbaConstants_h
...
#define kCameraHost @"192.168.42.1"
#define kCameraPort 7878
...
#define kUpdateConnectionStatusNotification   @"UpdateConnectionStatusNotification"
